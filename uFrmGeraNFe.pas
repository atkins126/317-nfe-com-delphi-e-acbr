...
uses uDmConexao, uDmNfe, pcnNFe, DateUtils, uLibrary;
...
begin
  ...
  begin
    ...
    Total.ICMSTot.vST     := (DmNFe.CdsTributoBASE_ST.AsFloat * DmNFe.CdsTributoALIQUOTA_ICMS.AsFloat) /100;
    ...
    Total.ICMSTot.vNF     := CdsNFeVALOR_TOTAL.AsFloat;
    //
...
//  DmNFe.ACBrNFe1.NotasFiscais.Assinar;
  DmNFe.ACBrNFe1.NotasFiscais.Items[0].SaveToFile;
  ShowMessage('Arquivo gerado em: '+DmNFe.ACBrNFe1.NotasFiscais.Items[0].NomeArq);
